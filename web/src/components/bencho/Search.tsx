// Search, from bencho.dev's "Search" block (MIT, © 2026 Lorenzo Cabra,
// bencho.dev/licence). Bencho names it Seek; the notes below keep that name.
// Its styles are the "Seek" section of web/src/index.css, where Bencho's
// design tokens are mapped onto this site's own.
...
/* the field's corner. 32 is half of its 64px height, which is
   ...
   CAACI: left fully round on purpose. The site draws every
   button, pill and toggle `rounded-full` (web/DESIGN_SYSTEM.md
   §4.1), and this is a round button that becomes a pill. The
   site's `rounded-xl` belongs to boxed form inputs; applied
   here it would turn the shut circle into a rounded square. */
const CORNER = 32;
