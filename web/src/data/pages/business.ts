...
export const businessServicesDataEN: BusinessServicesContent = {
  ...
  merchants: [
    ...
    },
    {
      ...
      discount: 'Member perk: free drink / $390 doc fee waived',
      address: '301 W Marketview Dr, Ste A, Champaign, IL 61822',
      phone: '(248) 850-8010',
      website: 'https://mystscc.com',
      desc: 'Curated pre-owned luxury and performance cars, plus detailing, vinyl wraps and paint protection. CAACI members get a free drink; paid members save the $390 documentation fee on a car purchase.',
    },
  ],
  events: [
    {
...
export const businessServicesDataZH: BusinessServicesContent = {
  ...
  merchants: [
    ...
    },
    {
      ...
      category: 'services',
      categoryLabel: '豪车展厅',
      discount: '会员福利：免费饮品 / 免 $390 文件费',
      address: '301 W Marketview Dr, Ste A, Champaign, IL 61822',
      phone: '(248) 850-8010',
      website: 'https://mystscc.com',
      desc: '精选二手豪华车与高性能车，并提供精细洗护、车身改色贴膜与漆面保护。CAACI 会员到店享免费饮品，付费会员购车免 $390 文件费。',
    },
  ],
  events: [
    {
