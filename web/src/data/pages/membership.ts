...
export const membershipPageDataEN: MembershipPageContent = {
  ...
  benefits: [
    ...
    'Save the $390 documentation fee when you buy a car from partner showroom MYST SCC (Troy, MI)',
  ],
  ...
  tiers: {
    free: {
      ...
      features: [
        ...
        'A free drink at partner showroom MYST SCC (Troy, MI)',
      ],
    },
    student: {
      period: 'per year',
      features: [
        ...
        'Save the $390 documentation fee on a car from partner MYST SCC (Troy, MI)',
      ],
    },
    individual: {
      period: 'per year',
...
export const membershipPageDataZH: MembershipPageContent = {
  ...
  benefits: [
    ...
    '在合作豪车展厅 MYST SCC（密歇根 Troy）购车，免除价值 $390 的文件费（documentation fee）',
  ],
  ...
  tiers: {
    free: {
      ...
      features: [
        ...
        '无需付款，永不过期',
        '可随时升级为付费会员，享受会员福利',
        '在合作豪车展厅 MYST SCC（密歇根 Troy）享免费饮品一杯',
      ],
    },
    student: {
      period: '每年',
      features: [
        ...
        '开具官方社区义工公益服务时长证明',
        '加入 CAACI 青年学生交流群',
        '在合作车行 MYST SCC（密歇根 Troy）购车，免 $390 文件费（documentation fee）',
      ],
    },
    individual: {
      period: '每年',
