...
function Site() {
  ...
  const toggleLang = () => {
    ...
    storeLang(nextLang);
    // Cross-fade the whole page: the old wording fades out where it stands and
    // the new one fades in over it. The page stays mounted and keeps its scroll.
    withViewTransition(() => setLang(nextLang));
